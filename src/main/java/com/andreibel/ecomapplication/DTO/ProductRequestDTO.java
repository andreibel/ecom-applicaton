...
public record ProductRequestDTO(@NotNull @NotBlank(message = "need product name") String name,
                                ...
                                @NotNull @PositiveOrZero(message = "price cant be negative") Double price,
                                ...
                                @NotNull @URL(message = "need the url of the image", protocol = "") String imageUrl) implements Serializable {
}